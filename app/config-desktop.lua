...
local redfish = {
	...
	MINOR = '0', -- a minor update. New functionality may have been added but nothing removed. Compatibility will be preserved with previous minorversions
	ERRATA = '2' -- something in the prior version was broken and needed to be fixed
}
