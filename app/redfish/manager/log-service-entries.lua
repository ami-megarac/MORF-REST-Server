...
-- Set the path names for manager log entry OEM extensions
local collection_oem_path = "manager.manager-logentry-collection"
...
-- ### GET request handler for Manager/LogServices/Entries
function LogServiceEntriesHandler:get(_manager_id, _log_id, id)
...
function LogServiceEntriesHandler:get_collection(response)
	...
	local prefix = "Redfish:Managers:"..instance..":LogServices:"..secondary_instance..":Entries"
	...
	local oem_array = oem_properties[secondary_instance] or {}
	local redis_responses
