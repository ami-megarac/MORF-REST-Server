...
local Lua_table_Base = {
    ...
    ["Messages"] = {
		...
		["EmptyJSONRequest"] = {
            ["Description"] = "Indicates that the given JSON request is empty",
            ["Message"] = "The request body submitted was empty. Please specify a valid JSON request.",
            ["Severity"] = "Critical",
            ["NumberOfArgs"] = 0,
            ["Resolution"] = "Ensure that the request body is not empty but valid JSON and resubmit the request."
        }
    }
}
